...
> **Note:** Uploading numerous large files may fail. In case of failure:
> 1. Stop the upload (as all subsequent uploads will begin failing) and take note of the last uploaded folder
...
## 3. Training the model - "sbatch [train_conda_final.sh](./train_conda_final.sh)"
...
## 4. Testing the model - "sbatch [test_conda_final.sh](./test_conda_final.sh)"
